...
<head>
	<title><fmt:message key="title.page.about"/></title>
</head>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 homebanner-holder">
				...
				<div id="product-tabs-slider" class="outer-top-vs wow fadeInUp">
					<ul class="nav nav-tabs mt-1">
						<li class="active"><a href="#">CEO Message</a></li>
						<li><a href='<c:url value="/front/about/1" />'>History</a></li>
			...
			<div class="wrapper-about col-xs-12 col-sm-12 col-md-12">
				...
				<div class="row message-info">
					...
					<div class="col-col-8 col-sm-8 col-xs-12">
						<div class="content">
							<c:if test="${not empty abouts and abouts.size() gt 0}">
