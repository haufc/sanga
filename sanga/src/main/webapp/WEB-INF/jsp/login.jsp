            ...
            <div class="form-holder">
                ...
                <div class="form-content">
                    <div class="form-items">
                    	<img src='<c:url value='/themes/admin/global_assets/images/sang-a.jpg'/>' width="400px" height="300px" style="margin-bottom: 25%">
                    	<%--
                        ...
                        <form method="post" id="loginForm" action="<c:url value='/login'/>">
                        	<span><fmt:message key="auth.login.userName"/></span>
                            <input class="form-control" type="text" name="username" placeholder="Enter username" required style="border-radius: 20px; width: 125%" autofocus="autofocus">
                            <span><fmt:message key="auth.login.password"/></span>
                            <input class="form-control" type="password" name="password" placeholder="Enter password" required style="border-radius: 20px; width: 125%">
