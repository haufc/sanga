...
<head>
	...
	<link href='<c:url value="/themes/admin/assets/css/lib.css"></c:url>' rel="stylesheet" type="text/css">
	<link href='<c:url value="/themes/admin/global_assets/js/plugins/toastr/toastr.min.css"></c:url>' rel="stylesheet" type="text/css">
	...
	<script src="<c:url value='/themes/admin/global_assets/js/plugins/toastr/toastr.min.js'/>"></script>
	<script src="<c:url value='/themes/admin/assets/js/lib.js'/>"></script>
