/* ------------------------------------------------------------------------------
 *
 *  # All process js for Project-form.jsp
 *
 * ---------------------------------------------------------------------------- */
...
var ProjectForm = function() {
	...
	var _componentCheckProjectCode = function() {
    ...
    var _componentProjectForm = function() {
        if (!$().fileinput) {
    ...
    return {
        init: function() {
			_componentProjectForm();
			_componentCheckProjectCode();
        }
    }
}();
...
var ProjectComponent = {
	initPhotos: function() {
		...
		var contextPath = getContext();
		$.ajax({
			url: contextPath + '/admin/project/load',
			method: 'GET',
			data: {pId : ProjectId},
